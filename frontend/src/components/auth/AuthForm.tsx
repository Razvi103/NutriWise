...
import { TextField, Button, Container, Typography, Box, Alert, Grid, Link as MuiLink, Divider } from '@mui/material';
    ...
    return (
        <Container component="main" maxWidth="xs">
            ...
            >
                ...
                {firebaseError && <Alert severity="error" sx={{ mt: 2, width: '100%' }}>{firebaseError}</Alert>}
